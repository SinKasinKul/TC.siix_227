...
$("#gridOnHandDetail").jqxGrid(
        {
            ...
            columns: [
              ...
              { text: 'Item Code', datafield: 'ITEMCD', minwidth: 120, align: 'center', cellsalign: 'center', aggregates: ['count']},
              { text: 'Batch No.', datafield: 'BATCH', width: 90, align: 'center', cellsalign: 'center'},
              { text: 'Qty', datafield: 'QTY', width: 80, align: 'center', cellsalign: 'right',cellsformat: 'F2'},
              { text: 'Status', datafield: 'STATUS_MAT', width: 100, align: 'center', cellsalign: 'center', filtertype: 'checkedlist'},
  ...
  $("#gridOnHandHis").jqxGrid(
          {
              ...
              columns: [
                ...
                { text: 'Tracking', datafield: 'SEIBAN', minwidth: 120, align: 'center', cellsalign: 'center'},
                { text: 'Item Code', datafield: 'ITEMCD', minwidth: 120, align: 'center', cellsalign: 'center', aggregates: ['count']},
                { text: 'Batch No.', datafield: 'BATCH', width: 100, align: 'center', cellsalign: 'center'},
                { text: 'IN Qty', datafield: 'IN_QTY', width: 130, align: 'center', cellsalign: 'right', cellsrenderer: CHK_QTY,cellsformat: 'F2', aggregates: ['sum']},
                { text: 'OUT Qty', datafield: 'OUT_QTY', width: 130, align: 'center', cellsalign: 'right', cellsrenderer: CHK_QTY,cellsformat: 'F2', aggregates: ['sum']},
                //{ text: 'Status', datafield: 'STATUS_MAT', width: 100, align: 'center', cellsalign: 'center'},
