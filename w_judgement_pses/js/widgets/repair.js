$(document).ready(function () {
  ...
  $("#Troubleshoot").jqxInput({ height: 30, width: 300});
  ...
  $("#gridBarcodeScan").jqxGrid(
          {
              ...
              columns: [
                ...
                { text: 'Barcode', datafield: 'Barcode', width: 300, align: 'center', cellsalign: 'center', aggregates: ['count']},
                ...
                { text: 'Troubleshoot', datafield: 'Troubleshoot', width: 300, align: 'center'},
                { text: 'EMP', datafield: 'EMP', width: 100, align: 'center', cellsalign: 'center'}/*,
...
function gridBarcodeScan(BC) {
  ...
  var insertBarcode = function(Sts){
      ...
      var Emp     = MainUserID;
      var Status  = Sts;
      var Troubleshoot = $("#Troubleshoot").val();
          $.ajax({
                    type: "GET",
                    url: "main.class.php",
                    dataType: "json",
