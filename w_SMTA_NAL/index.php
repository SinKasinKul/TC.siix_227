...
<div id='main_Tabs'>
    ...
    <div>
          <?php require_once('html/smta_nal.html');?>
    </div>
</div>
...
<script type="text/javascript" src="js/widgets/smta.js"></script>
<script type="text/javascript" src="js/widgets/bar_smta.js"></script>
...
<div id="passwordIT">
    ...
    <div style="overflow: hidden;">
      ...
      <table width="100%" height="100%" class="table table-striped table-bordered table-hover">
            ...
            <tr align='center'>
                <td valign='center'><input id="SMTALogin" type="button" value="Enter" class="btn text-muted text-center btn-success" size="10"/></td>
            </tr>
      </table>
      </form>
        </div>
