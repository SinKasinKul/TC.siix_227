...
$("#gridQRcodeSMTA").jqxGrid(
        {
            ...
            columns: [
              ...
              { text: 'Status', datafield: 'STATE_DESC', width: 80, align: 'center', cellsalign: 'center'}/*,
              { text: 'Date', datafield: 'DATE_UPDATE', width: 150, align: 'center', cellsalign: 'center'}*/
            ]
        });
});

function gridQRcodeSMTA(LotNo) {
            var LotNo = LotNo;
            var act = 'jsonMainProcess';
            var url = "smta.class.php?action="+act+"&LOT="+LotNo;
            ...
            var dataAdapter = new $.jqx.dataAdapter(source);
             $("#gridQRcodeSMTA").jqxGrid({source: dataAdapter});
