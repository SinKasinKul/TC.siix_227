...
$("#gridBarcodeScan").jqxGrid(
        {
            ...
            columns: [
              { text: 'Model', datafield: 'Model', minwidth: 150, align: 'center', cellsalign: 'center'},
              { text: 'Barcode', datafield: 'Barcode', width: 150, align: 'center', cellsalign: 'center', aggregates: ['count']},
              ...
              { text: 'Box No', datafield: 'BoxNo', width: 150, align: 'center', cellsalign: 'center'},
              { text: 'Client', datafield: 'MC', width: 120, align: 'center', cellsalign: 'center'},
