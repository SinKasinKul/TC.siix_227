...
<table width="100%">
  <tr>
    ...
    <td width="45%" bgcolor="#0099FF" class="white18" align="right" >&nbsp;&nbsp;&nbsp;<?=HEADER_NAME_II?></td>
    <!--td width="45%" bgcolor="#0099FF" class="white18" align="right" >&nbsp;&nbsp;&nbsp;<?=HEADER_NAME_III?></td-->
  </tr>
</table>
