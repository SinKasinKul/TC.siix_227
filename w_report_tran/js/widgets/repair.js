...
$("#gridBarcodeScan").jqxGrid(
        {
            ...
            columns: [
              { text: 'Model', datafield: 'ITEMDESC', width: 250, align: 'center', cellsalign: 'center'},
              { text: 'Barcode', datafield: 'Barcode', minwidth: 300, align: 'center', cellsalign: 'center', aggregates: ['count']},
              ...
              { text: 'Lot', datafield: 'LOT', width: 100, align: 'center', cellsalign: 'center'},
              { text: 'Machine', datafield: 'MC', width: 120, align: 'center', cellsalign: 'center'},
