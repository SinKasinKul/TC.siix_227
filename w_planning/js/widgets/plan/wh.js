            ...
            columns: [
              { text: 'Start', datafield: 'Start', width: 50, align: 'center', columntype: 'button', pinned: true, cellsrenderer: function () {
               ...
               { text: 'End', datafield: 'End', width: 50, align: 'center', columntype: 'button', pinned: true, cellsrenderer: function () {
                        ...
                        var Tracking = dataRecord.Tracking;
                        if(ID != ''){
                          var r = confirm("Do you want to finish production "+ Tracking + " ?");
                            if (r == true) {
                                MAIN_WH_UPD('End', ID);
                            }
                        }
              ...
              { text: '#Line', datafield: 'SMT_line', width: 80, align: 'center', cellsalign: 'center', pinned: true, filtertype: 'checkedlist'},
              { text: 'Priority', datafield: 'Priority', width: 100, align: 'center', cellsalign: 'left', filtertype: 'checkedlist', pinned: true},
              { text: 'Delivery Date', datafield: 'Delivery_date', width: 100, align: 'center', cellsalign: 'center'},
              { text: 'Plan Kitting', datafield: 'Schedule_Kitting_part', width: 100, align: 'center', cellsalign: 'center', filtertype: 'checkedlist'},
...
function MAIN_WH_UPD(vType,vID) {
...
function PLAN_SEC() {
  ...
  function MAIN_KITTING_SEC_CHART() {
              var pDate = '';
              var act = 'MAIN_KITTING_SEC_CHART';
              var url = "main.class.php?action="+act;
              var pData = {
                  Date : pDate
              };
