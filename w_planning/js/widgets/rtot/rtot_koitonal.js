$(document).ready(function () {
  ...
  $("#vbtExportOTTeam").click(function () {
    ...
    $("#vbtAddEmp").click(function () {
      ...
      var vEMPTeamdataAdapter = STBL_LIST_GROUP('KOITO/NAL');
      $("#vEMP_Team").jqxDropDownList({ source: vEMPTeamdataAdapter, placeHolder: "Select Group", displayMember: "Team", valueMember: "Team", width: '200px',theme: "darkblue"}); //, autoDropDownHeight: true
