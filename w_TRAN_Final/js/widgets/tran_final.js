  ...
  $("#gridBarcodeScan").jqxGrid(
          {
              ...
              columns: [
                ...
                { text: 'SMTB Status', datafield: 'STATE_SMTA_DESC', width: 100, align: 'center', cellsalign: 'center', cellsrenderer: Status},
                { text: 'SMTA Status', datafield: 'STATE_SMTB_DESC', width: 100, align: 'center', cellsalign: 'center', cellsrenderer: Status},
                { text: 'STATUS', datafield: 'STATE_DESC', width: 100, align: 'center', cellsalign: 'center', cellsrenderer: Status},
                /*{ text: 'NHL', datafield: 'NHL', width: 50, align: 'center', cellsalign: 'center'},
                { text: 'NG', datafield: 'NG', width: 60, align: 'center', cellsalign: 'center'},*/
...
function gridBarcodeScan(LotNo,Seiban) {
            ...
            var source =
            {
                ...
                datafields: [
                    ...
                    { name: 'STATE_SMTA', type: 'string' },
                    { name: 'STATE_SMTA_DESC', type: 'string' },
                    { name: 'STATE_SMTB', type: 'string' },
                    { name: 'STATE_SMTB_DESC', type: 'string' },
                    { name: 'STATE_MN', type: 'string' },
                    { name: 'STATE_MN_DESC', type: 'string' },
                    { name: 'STATE_ICT', type: 'string' },
                    { name: 'STATE_ICT_DESC', type: 'string' },
                    { name: 'STATE_DESC', type: 'string' },
                    { name: 'NHL', type: 'string' },
                    { name: 'NG', type: 'string' },
