...
$("#gridBarcodeScan").jqxGrid(
        {
            ...
            columns: [
              { text: 'Model', datafield: 'ITEMDESC', width: 150, align: 'center', cellsalign: 'center'},
              { text: 'Barcode', datafield: 'Barcode', width: 400, align: 'center', cellsalign: 'center', aggregates: ['count']},
              { text: 'Process', datafield: 'StepName', width: 80, align: 'center', cellsalign: 'center'},
              { text: 'STATUS', datafield: 'STATE_DESC', width: 400, align: 'center', cellsalign: 'center', cellsrenderer: Status},
              ...
              { text: 'Machine', datafield: 'CLIENT', width: 150, align: 'center', cellsalign: 'center'},
