$(document).ready(function () {
  ...
  $("#BarcodeScan").jqxInput({ height: 30, width: 400, minLength: 1});insertBarcode
  ...
  $("#gridBarcodeScan").jqxGrid(
          {
              ...
              columns: [
                ...
                { text: 'STATUS SMTA', datafield: 'STATE_STEP1_DESC', width: 100, align: 'center', cellsalign: 'center', cellsrenderer: Status},
                { text: 'Function', datafield: 'STATE_STEP2_DESC', width: 100, align: 'center', cellsalign: 'center', cellsrenderer: Status},
...
function gridBarcodeScan(LotNo,Seiban) {
            ...
            var source =
            {
                ...
                datafields: [
                    ...
                    { name: 'STATE_STEP1_DESC', type: 'string' },
                    { name: 'STATE_STEP2_DESC', type: 'string' },
