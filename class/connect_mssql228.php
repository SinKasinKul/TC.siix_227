...
* Connect MSsql
*/
class connect_mssql228
{

	private $hostName = DB_HOST_MSSQL_228;
	private $user= DB_USER_MSSQL_228;
	private $Password = DB_PASSWORD_MSSQL_228;
	private $dbName = DB_NAME_MSSQL_228;
